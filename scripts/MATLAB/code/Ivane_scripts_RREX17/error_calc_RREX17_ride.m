function [Er_tot,Er_ek,Er_synopt,Er_phy,Er_bott,Er_nois,ins_nois,er_ins,er_aleatoire] = error_calc_RREX17(section,ind_reg,region,region_vert)
...
%% ========================================================================
STA = [56:69 76:125];STA=STA(:); nsta=size(STA,1); npair=nsta-1; m=length(STA); %ride RREX17 
