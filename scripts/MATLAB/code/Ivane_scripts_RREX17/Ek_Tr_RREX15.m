...
section=transect{q}; disp(['section ' section]);

methods={'moyenne','each'};
methode=methods{2}; disp(['methode ' methode]);

dat={'era','ncep'};
data=dat{qqq}; disp(['data ' data]);
...
if strcmp(section,'ride')
    ...
    geo_juld = [01 01 02 02 02 02 02 02 03 03 03 03 03 04 04 04 04 05 05 05 05 06 06 06 06 06 06 06 07 07 07 07 07 08 08 08 08 08 08 09 09 09 09 09 09 10 10 10 10 11 11 11 12 12];
    load C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/RREX/Ivane_output_RREX15/vitesse_abs/OS38_section_ride_polyfit.mat
...
elseif strcmp(section,'ovide')
    ...
    geo_juld = [22 22 22 23 23 23 24 24 25 26 26 26 27 27 27 27 27 27 28]; % Jours associes aux positions geo 
    load C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/RREX/Ivane_output_RREX15/vitesse_abs/OS38_section_ovide_polyfit.mat % fichier pour lat_abs/lon_abs
...
elseif strcmp(section,'south')
    ...
    load C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/RREX/Ivane_output_RREX15/vitesse_abs/OS38_section_south_polyfit.mat
...
elseif strcmp(section,'north')
    ...
    geo_juld = [30 30 30 30 31 31 31 31 01 01 01 01 02 02 02 02 03 03 03 03 04];
    load C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/RREX/Ivane_output_RREX15/vitesse_abs/OS38_section_north_polyfit.mat
...
if strcmp(data,'era')
    ...
    ewss_era = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/era/data2015_ewss.nc','ewss');
    nsss_era = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/era/data2015_nsss.nc','nsss');
    gregd_era = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/era/data2015_ewss.nc','time');
    lon_era = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/era/data2015_ewss.nc','longitude');
    lat_era = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/era/data2015_ewss.nc','latitude');
...
elseif strcmp(data,'ncep')
    ...
    taux = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/ncep/ncep2_atln_uflx_2015.nc','uflx'); taux = permute(taux,[3 2 1]);
    tauy = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/ncep/ncep2_atln_vflx_2015.nc','vflx'); tauy = permute(tauy,[3 2 1]);
    juld = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/ncep/ncep2_atln_uflx_2015.nc','time');
    lon = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/ncep/ncep2_atln_uflx_2015.nc','lon');
    lat = ncread('C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/Wind_Stress/ncep/ncep2_atln_uflx_2015.nc','lat');
...
lon = ncload(fctd,'LONGITUDE'); lon = lon(STA);
lat = ncload(fctd,'LATITUDE');  lat = lat(STA);
d = ncload(fctd,'DEPH'); d = d(STA);
...
if save_ek == 1
    rept='C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/data/RREX/Ivane_output_RREX15/transport_Ekman/';
