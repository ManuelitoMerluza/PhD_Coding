...
% the RREX2015 cruise (with or without bottom triangles, bottom triangles can be extrapolated by 4 different methods: planfit, 
...
sgpan = dynh(:,iss); % Specific volume anomaly at shallower station
dgpan = dynh(:,isd); % Specific volume anomaly at deeper station
...
if save_vgeo == 1
    saveas(gcf, ['C:/Users/mitg1n25/Desktop/PhD/PhD_Coding/docs/figures/Ivane_RREX_output/vgeo2015',titre_fig,'.png'])
end
%% ========================================================================
