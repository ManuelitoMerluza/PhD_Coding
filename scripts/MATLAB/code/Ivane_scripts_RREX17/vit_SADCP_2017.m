...
% sections of the RREX 2017 cruise. Divide segments of 2 km from the SADCP
% of the RREX2017 cruise.
%
% see also : vit_geo_2017.m vit_geo_abs_2017.m 
...
switch sadcp
    case 'OS38'
        fsadcp = '../../DATA/HYDRO/RREX2017/sadcp/OS38/nce/'; %(sorties CASCADE Herlé)
        file_sadcp = 'AT_RREX17_OS38_osite_m09_004_12_fhv21_sec_02mx21.nc'
        corr_value = 'm09_004_12_fhv21_sec_02mx21';
        file_save=['vitesse_sadcp_RREX17_',sadcp,'_',section,'_',corr_value,]; %nom du fichier de sortie sauvegardé 
    case 'OS150'
        fsadcp = '../../DATA/HYDRO/RREX2017/sadcp/OS150/nce/'; %(sorties CASCADE Herlé)
        %file_sadcp = 'AT_RREX17_OS150_osite_08_015_38_sec_02mx21.nc'
        file_sadcp = 'AT_RREX17_OS150_osite_08_015_38_fhv1_sec_02mx1.nc'
        corr_value = '08_015_38_fhv1_sec_02mx1';
        file_save=['vitesse_sadcp_RREX17_',sadcp,'_',section,'_',corr_value,];
         
end
rept = '../matlab_output_RREX17/vitesse_adcp/'; %repertoire save file
%% ========================================================================
