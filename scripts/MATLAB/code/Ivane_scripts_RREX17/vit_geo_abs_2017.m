...
manual_REF = 1;
methode = 'cstslope'; %'pfit' (fit a plane), 'polyfit' (fit a polynomial), 'cstslope' (constant slope), 'horiz' (horizontal extrapolation)
bottom_v = 0;
...
if save_trsp == 1
    ...
    save([rept 'tr_z_RREX17_' section '_' methode],'tr_z','X','X_ctd'); % saves the tr_z variable
end
