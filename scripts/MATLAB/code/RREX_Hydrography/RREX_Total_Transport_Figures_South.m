...
xlims=[48.4 64; -39 -30;-37.3 -27.3 ;-34 -21];
...
load('RREX_T_tot_south.mat'); % Loads the cumulated transports

% 2015
cruise='RREX2015 ';

points=[14,1,1,1]; % This is for highlighting points used for sumating transport along ridge
...
annotation('textbox',[.62 .62 .15 .2], 'String',[num2str(T_south2015(2)) ' ± ' num2str(error_south2015(2)) ' Sv'],'EdgeColor','none','Color','b','FontSize',10,'FontWeight','bold')
annotation('textbox',[.62 .595 .15 .2], 'String',[num2str(T_south2017(2)) ' ± ' num2str(error_south2017(2)) ' Sv'],'EdgeColor','none','Color','r','FontSize',10,'FontWeight','bold')

annotation('textbox',[.365 .62 .15 .2], 'String',[num2str(T_south2015(1)) ' ± ' num2str(error_south2015(1)) ' Sv'],'EdgeColor','none','Color','b','FontSize',10,'FontWeight','bold')
annotation('textbox',[.365 .595 .15 .2], 'String',[num2str(T_south2017(1)) ' ± ' num2str(error_south2017(1)) ' Sv'],'EdgeColor','none','Color','r','FontSize',10,'FontWeight','bold')
