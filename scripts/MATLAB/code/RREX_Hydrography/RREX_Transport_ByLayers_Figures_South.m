...
T_mag2015=NaN(4,2); T_mag2017=NaN(4,2);
...
%% Plot the density countour and bathymetry (both cruises)

xlims=[48 64; -39 -30.5;-37.3 -27.3 ;-34.5 -20];
...
figure()
set(gcf, 'Position', [185, 0, 1000, 900]); % 1200 width
% 2015
...
xline(-37.6,'--'); xline(-34,'--') ; xline(-31.3,'--') ;
ylabel('Depth (km)')
xlim(xlimm); xlabel(xlab);
title('RREX - Transport by Layers in South Transect','FontName','LMRoman10','FontSize',15,'FontWeight','bold')
grid on

% Adds a label for each isopycnal
annotation('textbox',[.135 .89 .08 .03], 'String','\sigma_0 = 27.52 kg/m^3','EdgeColor','none','Color','k','FontSize',9.5,'FontWeight','bold')
annotation('textbox',[.135 .795 .08 .03], 'String','\sigma_0 = 27.71 kg/m^3','EdgeColor','none','Color','k','FontSize',9.5,'FontWeight','bold')
annotation('textbox',[.135 .44 .07 .04], 'String','\sigma_0 = 27.8 kg/m^3','EdgeColor','none','Color','k','FontSize',9.5,'FontWeight','bold','BackgroundColor','w','HorizontalAlignment','left','VerticalAlignment','middle')


% We add the transport calculated by sections
% Layer 1 2015
annotation('textbox',[.44 .73 .15 .2], 'String',[num2str(T_mag2015(1,1)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
annotation('textbox',[.66 .72 .15 .2], 'String',[num2str(T_mag2015(1,2)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
% Layer 1 2017
annotation('textbox',[.49 .695 .15 .2], 'String',[num2str(T_mag2017(1,1)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')
annotation('textbox',[.73 .685 .15 .2], 'String',[num2str(T_mag2017(1,2)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')

% Layer 2 2015
annotation('textbox',[.37 .615 .15 .2], 'String',[num2str(T_mag2015(2,1)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
annotation('textbox',[.595 .575 .15 .2], 'String',[num2str(T_mag2015(2,2)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
% Layer 2 2017
annotation('textbox',[.50 .57 .15 .2], 'String',[num2str(T_mag2017(2,1)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')
annotation('textbox',[.735 .565 .15 .2], 'String',[num2str(T_mag2017(2,2)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')

% Layer 3 2015
annotation('textbox',[.31 .345 .15 .2], 'String',[num2str(T_mag2015(3,1)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
annotation('textbox',[.62 .40 .15 .2], 'String',[num2str(T_mag2015(3,2)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
% Layer 3 2017
annotation('textbox',[.455 .35 .15 .2], 'String',[num2str(T_mag2017(3,1)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')
annotation('textbox',[.74 .36 .15 .2], 'String',[num2str(T_mag2017(3,2)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')

% Layer 4 2015
annotation('textbox',[.28 .28 .06 .03], 'String',[num2str(T_mag2015(4,1)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
annotation('textbox',[.652 .345 .06 .03], 'String',[num2str(T_mag2015(4,2)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
% Layer 4 2017
annotation('textbox',[.37 .30 .06 .03], 'String',[num2str(T_mag2017(4,1)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')
annotation('textbox',[.73 .26 .06 .03], 'String',[num2str(T_mag2017(4,2)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')

hold off
box on

figpath='C:\Users\mitg1n25\Desktop\PhD\PhD_Coding\docs\figures\Velocity_RREX';
imgname={'11a.T_layer_south2015.png','11b.T_layer_south2017.png','11c.T_layer_south.png'};
