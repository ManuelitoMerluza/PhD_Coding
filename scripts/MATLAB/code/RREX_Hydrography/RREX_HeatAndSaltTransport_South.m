...
%% This the defines the transect being used

q=2; % 'ridge','south','ovide','north'
...
section=transect{q};
section2015=transects2015{q}; section2017=transects2017{q};
...
ax2=subplot(2,1,2);
points=[14,1,1,1]; aux2=T_sal2015(points);
points=[2, 14]; aux2(3:4)=T_sal2017(points);
