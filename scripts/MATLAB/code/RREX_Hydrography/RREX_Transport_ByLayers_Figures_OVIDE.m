...
xlims=[48 64; -39 -30.5;-38 -27 ;-34.5 -20];
...
figure()
set(gcf, 'Position', [185, 0, 1000, 900]); % width 1200
% 2015
...
title('RREX - Transport by Layers in OVIDE Transect','FontName','LMRoman10','FontSize',15,'FontWeight','bold')
grid on

% Adds a label for each isopycnal
annotation('textbox',[.13 .89 .08 .03], 'String','\sigma_0 = 27.52 kg/m^3','EdgeColor','none','Color','k','FontSize',9.5,'FontWeight','bold')
annotation('textbox',[.13 .83 .08 .03], 'String','\sigma_0 = 27.71 kg/m^3','EdgeColor','none','Color','k','FontSize',9.5,'FontWeight','bold')
annotation('textbox',[.135 .40 .07 .04], 'String','\sigma_0 = 27.8 kg/m^3','EdgeColor','none','Color','k','FontSize',9.5,'FontWeight','bold')


% We add the transport calculated by sections
% Layer 1 2015
annotation('textbox',[.56 .728 .15 .2], 'String',[num2str(T_mag2015(1,1)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
annotation('textbox',[.66 .72 .15 .2], 'String',[num2str(T_mag2015(1,2)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
% Layer 1 2017
annotation('textbox',[.56 .656 .15 .2], 'String',[num2str(T_mag2017(1,1)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')
annotation('textbox',[.76 .63 .15 .2], 'String',[num2str(T_mag2017(1,2)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')

% Layer 2 2015
annotation('textbox',[.45 .67 .15 .2], 'String',[num2str(T_mag2015(2,1)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
annotation('textbox',[.77 .515 .15 .2], 'String',[num2str(T_mag2015(2,2)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
% Layer 2 2017
annotation('textbox',[.455 .60 .15 .2], 'String',[num2str(T_mag2017(2,1)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')
annotation('textbox',[.63 .52 .15 .2], 'String',[num2str(T_mag2017(2,2)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')

% Layer 3 2015
annotation('textbox',[.36 .35 .15 .2], 'String',[num2str(T_mag2015(3,1)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
annotation('textbox',[.66 .38 .15 .2], 'String',[num2str(T_mag2015(3,2)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
% Layer 3 2017
annotation('textbox',[.455 .35 .15 .2], 'String',[num2str(T_mag2017(3,1)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')
annotation('textbox',[.745 .325 .15 .2], 'String',[num2str(T_mag2017(3,2)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')

% Layer 4 2015
annotation('textbox',[.37 .30 .06 .03], 'String',[num2str(T_mag2015(4,1)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
annotation('textbox',[.69 .38 .06 .03], 'String',[num2str(T_mag2015(4,2)) ' Sv'],'EdgeColor','none','Color','b','FontSize',11,'FontWeight','bold')
% Layer 4 2017
annotation('textbox',[.455 .37 .06 .03], 'String',[num2str(T_mag2017(4,1)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')
annotation('textbox',[.775 .28 .06 .03], 'String',[num2str(T_mag2017(4,2)) ' Sv'],'EdgeColor','none','Color','r','FontSize',11,'FontWeight','bold')

hold off
box on

figpath='C:\Users\mitg1n25\Desktop\PhD\PhD_Coding\docs\figures\Velocity_RREX';
imgname={'12a.T_layer_ovide2015.png','12b.T_layer_ovide2017.png','12c.T_layer_ovide.png'};
