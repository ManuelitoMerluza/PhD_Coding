...
info.pmin = 4;
info.pmax = 4000; %%%CHANGE: maximum depth
info.dp = 4;
info.dpD = 8;
info.dpGr = 8;
info.dpTr = 4;
...
folder_orig = 'C:/Users/Manuelito/Desktop/PhD/Year 1 - 2026/Microstructure Data/RREX/2017_113065/'; % Defines the folder where the original data is
...
for i = 1:Nf
    ...
    tic
    [BINNED0,SLOW0] = resolve_VMP_profile_shear_RREX2017(DAT,info,filename,PLOT);
    toc
...
save('RREX2017_processed_VMP6000_ManuTest.mat', '-struct' , 'OUTPUT')
