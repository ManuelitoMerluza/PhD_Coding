...
% This is the script I'll use to plot the results of the RREX2017 VMP data
...
folder='C:/Users/mitg1n25/Desktop/PhD/Year 1 - 2026/Microstructure Data/RREX/113067';
...
sgtitle('VMP Data Along the Ridge')

saveas(gcf,'RREX2017_ridge_epsilon.png')
...
saveas(gcf,'RREX2017_ridge_chi.png')
...
sgtitle('VMP Data Along the Ridge - Hydrography')

%saveas(gcf,'RREX2017_ridge_hydrography.png')

%% 2) Transect 1 (the one in the south across the ridge)
...
sgtitle('VMP Data Across the Ridge')

saveas(gcf,'RREX2017_crossridge_epsilon.png')
...
saveas(gcf,'RREX2017_crossridge_chi.png')
...
sgtitle('VMP Data Across the Ridge - Hydrography')

% saveas(gcf,'RREX2017_crossridge_hydrography.png')
...
sgtitle('VMP Data Along 63°N West of Ridge')

saveas(gcf,'RREX2017_westridge_epsilon.png')
...
saveas(gcf,'RREX2017_westridge_chi.png')
...
sgtitle('VMP Data Along 63°N West of Ridge - Hydrography')

% saveas(gcf,'RREX2017_westridge_hydrography.png')
...
saveas(gcf,'MeanShearRREX2017.png')
...
subplot(1,2,1)
hold on
plot(ridgeSH1,pres,'-b','LineWidth',1.5)
plot(trans1SH2,pres,'-g','LineWidth',1.5)
plot(trans2SH1,pres,'-r','LineWidth',1.5)
hold off
...
hold on
plot(ridgeXi1,pres,'-b','LineWidth',1.5)
plot(trans1Xi1,pres,'-g','LineWidth',1.5)
plot(trans2Xi1,pres,'-r','LineWidth',1.5)
hold off
ax=gca; ax.XScale='log';
set(gca,'YDir','reverse'); ylim([100 4000])
xlim(lim); xticks(ax, logspace(log10(lim(1)), log10(lim(2)), n));
title('Region Averaged \chi [K^2/s]'); grid on
legend('Ridge','Cross-Ridge','West of Ridge');

sgtitle('RREX 2017 VMP Data')

% saveas(gcf,'RegionXiREXX2017.png')
...
saveas(gcf,'RREX2017_ridge_turbulence.png')
...
saveas(gcf,'RREX2017_crossridge_turbulence.png')
...
saveas(gcf,'RREX2017_westridge_turbulence.png')
