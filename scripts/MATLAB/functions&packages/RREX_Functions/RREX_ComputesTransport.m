...
dens2015 = (dens2015_CTD(:,1:end-1)+dens2015_CTD(:,2:end))*0.5;
% This of omitting NaNs
densaux=dens2015_CTD; densaux(isnan(densaux))=0;
densaux_m=(densaux(:,1:end-1)+densaux(:,2:end))*0.5; densaux_m(densaux_m==0)=NaN;
dens2015=densaux_m;

dens2017_CTD=ncread(filenames(2).name,'SIG0'); dens2017_CTD=dens2017_CTD(:,2:end);
dens2017= (dens2017_CTD(:,1:end-1)+dens2017_CTD(:,2:end))*0.5;
% This of omitting NaNs
densaux=dens2017_CTD; densaux(isnan(densaux))=0;
densaux_m=(densaux(:,1:end-1)+densaux(:,2:end))*0.5; densaux_m(densaux_m==0)=NaN;
dens2017=densaux_m;

layer1_2015=dens2015< 27.52; 
layer1_2017=dens2017< 27.52;

layer2_2015=dens2015>= 27.52 & dens2015<27.71;
layer2_2017=dens2017>= 27.52 & dens2017<27.71; 

layer3_2015=dens2015>= 27.71 & dens2015<27.8;
layer3_2017=dens2017>= 27.71 & dens2017<27.8;
