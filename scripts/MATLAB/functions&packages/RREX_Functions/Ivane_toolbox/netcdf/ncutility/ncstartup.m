...
%path(path, fullfile(matlabroot, toolbox_area, 'netcdf', 'getcdf', ''))

toolbox_area = '/home1/armen/perso/plhermin/matlab/';
...
path(path, fullfile(toolbox_area, 'netcdf', 'ncfiles', ''))
path(path, fullfile(toolbox_area, 'netcdf', 'getcdf', ''))
