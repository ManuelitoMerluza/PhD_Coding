%------------------------------------------------------------------------------
%
% dynamg        - calculates vertical modes of an arbitrary N**2 profile
%                 with free surface 
%
%                !!! Attention: Utiliser des N**2 non nuls pour le moment !!!
%                !!! Attention: verifier condition surface libre !!!
%
%  call:  [rossby, fmod, gmod] = dynamg(bv2, zz, ylat, nmod, iop)
%  or     [rossby, fmod, gmod] = dynamg(bv2, zz, ylat, nmod)
%
%------------------------------------------------------------------------------
%
% Version:
...
function [rossby, fmod, gmod] = dynamg(bv2, zz, ylat, nmod, iop)
