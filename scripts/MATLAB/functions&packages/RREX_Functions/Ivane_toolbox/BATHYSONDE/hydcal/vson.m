...
function [ssp,info]=sndspd90(D,T90,S,equation);
...
%
%
%          2) SND_SPD(P,T,S,'del grosso') returns the sound speed (m/sec) 
...
% 06/11/2003 TT
% Modified to account for T90 i.e. it suppose that the input temperature is T90
% 
T = T90 * 1.00024;
