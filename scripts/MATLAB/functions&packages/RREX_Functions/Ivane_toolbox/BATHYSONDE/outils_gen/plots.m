...
% **************************************************************
%
% modifie par C.Lagadec 16/01/14
% ***************************************************************
...
% Entries:
% label a declarer dans la macro de dessin et dans plots
%
%lab = strjust(strvcat('Pression (dbar)','Temperature (C)','Salinite (psu)','Oxygene (micromole/kg)'),'center');
%
lab = strjust(strvcat('Pressure (dbar)','Temperature (C)','Salinity (psu)','Oxygen (micromole/kg)'),'center');
...
% xlabel
  xlabel(lab(n+1,:),'FontSize',11,'Fontweight','bold');
% ici ylabel axe pression
  if n == 1, ylabel(lab(1,:),'FontSize',11,'Fontweight','bold'),
%  else set(haxes(n),'YTick',[]) 
  else set(haxes(n),'YTick',[],'YColor','w')
  end
