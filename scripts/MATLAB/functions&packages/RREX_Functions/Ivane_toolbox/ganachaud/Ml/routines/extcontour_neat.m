function [CS,H] = extcontour(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, ...
                             arg9, arg10,arg11,arg12,arg13,arg14,arg15,arg16, ...
                             arg17,arg18,arg19,arg20);
%
%  EXTCONTOUR 		extended contouring package.
%
%  EXTCONTOUR(Z) 	a contour plot of matrix Z treating the values in Z
%        		as heights above a plane.
%
%  EXTCONTOUR(X,Y,Z) 	a contour plot of matrix Z where X and Y are vectors, 
%			specifies the X- and Y- axes used on the plot.
%        		X and Y can also be matrices of the same size as Z,
%        		in which case they specify a surface in an identical
%        		manner as SURFACE.
%
%  EXTCONTOUR(Z,N) and 
%  EXTCONTOUR(X,Y,Z,N) 	same as above, but draw N contour lines, 
%        		overriding the default automatic value.
%
%  EXTCONTOUR(Z,V) and 
%  EXTCONTOUR(X,Y,Z,V) 	same as above, but draw LENGTH(V) contour lines 
