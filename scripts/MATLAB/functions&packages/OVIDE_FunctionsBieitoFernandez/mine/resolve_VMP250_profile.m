...
%     
    ...
    legend('T01','sh1','sh2','maxT','fontsize',7,'location','southeast')
    ...
    legend('T01_f','T01_c','fontsize',7,'location','southeast')
    xlabel('\chi (K^2 s^{-1})')
    set(gca,'yticklabel',[])
    set(gca,'YDir','reverse')
    set(gca,'xscale','log')
    ...
    hold on
    plot(BIN.KOsbT1,BIN.pres,'-','linewidth',1,'markersize',4)
    plot(BIN.KOsb1,BIN.pres,'-','linewidth',1,'markersize',4)
    plot(BIN.KOsb2,BIN.pres,'-','linewidth',1,'markersize',4)
    legend('T01 (O&C)','T01 (O)', 'SH1 (O)','SH2 (O)','fontsize',7,'location','southeast')
    xlabel('K (m^2 s^{-1})')
    ylabel('p (db)')
    set(gca,'YDir','reverse')
    set(gca,'xscale','log')
